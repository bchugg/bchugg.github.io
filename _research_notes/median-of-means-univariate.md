...
It turns out that there is a simple estimator that achieves precisely what we want (and more). The median-of-means estimator proceeds as follows. We split the data into $$k$$ groups. To keep the arithmetic easy, we will assume that $$n$$ is a multiple of $$k$$. Formally, let $$G_1,\dots,G_k$$ be any partition of $$[n]$$ such that $$|G_i|=n/k$$, i.e., $$\cup G_i=[n]$$ and $$G_i\cap G_j=\emptyset$$ for all distinct $$i$$ and $$j$$. 
Let 
