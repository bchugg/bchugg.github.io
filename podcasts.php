...
<body>
	...
	<div class='container-fluid main-body'>
		<div class='col-sm-6 col-sm-offset-3 podcasts'>
			<h3 class='text-center'>Podcasts</h3>
			<h4>
				<ul>
					<li>
						<em>80,000 hours podcast</em>, hosted by Rob Wiblin. 
						<br>
					...
					<li>
						...
						<br> 
						I never know if I'm more excited by the history itself or Daniele's amazing Italian accent.  
					</li>
					<li>
					...
					<li>
						...
						<br> 
						"I'm here with &lsaquo;firstname&rsaquo; &lsaquo;lastname&rsaquo;. &lsaquo;Firstname&rsaquo;, thanks for coming on the podcast."
					</li>
					<li>
